...
class crop(object):
    ...
    def __call__(self, sample):
        ...
        LR_img = LR_img.reshape(120, 160, 3)
        GT_img = GT_img.reshape(480,640,3)
        ...
        ty = iy * self.scale
        #print("LR_PATCH")
        #print(iy ,":", iy + self.patch_size)
        #print(ix ,":", ix + self.patch_size)
        #print("GT_PATCH")
        #print(ty ,":", ty + (self.scale * self.patch_size))
        #print(tx ,":", tx + (self.scale * self.patch_size))
